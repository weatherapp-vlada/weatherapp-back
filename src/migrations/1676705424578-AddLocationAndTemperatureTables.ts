...
export class AddLocationAndTemperatureTables1676705424578
  implements MigrationInterface
{
  name = 'AddLocationAndTemperatureTables1676705424578';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "temperature" ("timestamp" TIMESTAMP NOT NULL, "location_id" integer NOT NULL, "temperature_celsius" numeric(5,2) NOT NULL, CONSTRAINT "UQ_c21c4bb738c164c7b3016276d28" UNIQUE ("timestamp", "location_id"), CONSTRAINT "PK_c21c4bb738c164c7b3016276d28" PRIMARY KEY ("timestamp", "location_id"))`,
    );
    await queryRunner.query(
